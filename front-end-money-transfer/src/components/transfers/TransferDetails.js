    ...
    useEffect(() => {
        const fetchTransferDetails = async () => {
            try {
                ...
                if (transferDetails && transferDetails.accountFrom && transferDetails.accountTo) {
                    // Fetch sender user details
                    const senderUserDetails = await getUserByAccountId(transferDetails.accountFrom);
                    ...
                    const receiverUserDetails = await getUserByAccountId(transferDetails.accountTo);
                    ...
                    console.error('Invalid accountFrom or accountTo values in transfer details:', transferDetails);
                }
            } catch (error) {
